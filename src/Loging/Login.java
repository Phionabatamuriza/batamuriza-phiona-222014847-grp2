...
public Login() {
    ...
    forgotPasswordButton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
            ...
            String email = JOptionPane.showInputDialog(Loging.Login.this, "Enter your email:");
            if (email != null && !email.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(Loging.Login.this, "A password reset link has been sent to your email.");
            } else {
                JOptionPane.showMessageDialog(Loging.Login.this, "Please enter a valid email.");
            }
        }
    });
    ...
    createAccountButton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
       	 ...
       	 Sinup registrationForm = new Sinup();
